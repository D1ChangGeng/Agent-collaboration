...
profile acs_bwrap /opt/acs/codex-sandbox/bin/bwrap flags=(attach_disconnected,mediate_deleted) {
  allow capability,
  ...
  allow pix /** -> &acs_bwrap//&acs_unpriv_bwrap,
...
profile acs_unpriv_bwrap flags=(attach_disconnected,mediate_deleted) {
